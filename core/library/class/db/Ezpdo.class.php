<?php
	...
	*/
	...
	if ( ! class_exists ('Ezcore') ) die('<b>Fatal Error:</b> ezSQL_pdo requires ezSQLcore (Ezcore.class.php) to be included/loaded before it can be used');

	class Ezpdo extends Ezcore
	{
